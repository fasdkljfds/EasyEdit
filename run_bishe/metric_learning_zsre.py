...
def finetune_sentence_transformer(
    ...
    # --- 1. 准备数据、加载模型--
    train_dataset, eval_dataset = prepare_triplet_data_zsre(root_dir=data_root_dir, dataset_configs=data_configs)
...
if __name__ == "__main__":
    ...
    multi_area_root_dir = 'EasyEdit/data/wise'

    train_hparams = {
        # 模型相关参数
        "base_model_name": 'sentence-transformers/all-MiniLM-L6-v2',
        "output_model_dir": './finetuned_sbert_triplet',
        "final_model_subdir": 'final_model_2',
        # 损失函数相关参数
